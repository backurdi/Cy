...
const linkSelect = (el) => {
  ...
  for (let i = 0; i < contentContainer.children.length; i++) {
    contentContainer.children[i].style.opacity = 0;
  }
  contentContainer.innerHTML = '';

  if (serviceList[0][selectedLink].order === 1) {
    contentContainer.insertAdjacentHTML('afterbegin', contentImg + contentText);
  } else if (serviceList[0][selectedLink].order === 2) {
    contentContainer.insertAdjacentHTML('afterbegin', contentText + contentImg);
  }
